...
namespace ConsoleApp13
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Курсы валют! USD = 55 RUB, EUR = 60 RUB, 1 USD = 1 EUR, RUB = 10 USD либо 15 EUR");
            ...
            switch (userInput)
            {
                case "1":
                    ...
                    {
                        ruble -= currencyCount;
                        dollar += currencyCount / rubleToDollar;
                    }
                    else
                    {
                ...
                case "2":
                    ...
                    if (dollar >= currencyCount)
                    {
                        ...
                        ruble += currencyCount * dollarToRuble;
                    }
                    else
                    {
                        Console.WriteLine("Недостаточно средств");
                ...
                case "5":
                    ...
                    {
                        euro -= currencyCount;
                        dollar += currencyCount / euroToDollar;
                    }
                    else
                    {
                        Console.WriteLine("Недостаточно средств");
                ...
                case "6":
                    ...
                    {
                        dollar -= currencyCount;
                        euro += currencyCount / dollarToEuro;
                    }
                    else
                    {
                        Console.WriteLine("Недостаточно средств");
